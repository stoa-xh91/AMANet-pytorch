...
class DensePoseResultsMplContourVisualizer(DensePoseResultsVisualizer):
    def __init__(self, levels=15, **kwargs):
        self.levels = levels
    ...
    def visualize_iuv_arr(self, context, iuv_arr: np.ndarray, bbox_xywh: Boxes) -> Image:
        ...
        plt.contour(u, self.levels, extent=extent,linewidths = 0.7, **self.plot_args)
        plt.contour(v, self.levels, extent=extent,linewidths = 0.7, **self.plot_args)
